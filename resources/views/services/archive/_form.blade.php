...
<div class="">
	...
	<div class="form-group">
		<label for="articleCategorySelect">글 분류</label>
    	<select name="category_id" class="form-control" title="카테고리" id="articleCategorySelect">
	...
	<div class="form-group">
		<label for="articleReference">출처</label>
		<input name="reference" type="text" id="articleReference" class="form-control" value="{{ $article->reference }}" placeholder="출처" aria-label="출처">
	</div>	
</div>