...
class PunycodeCalculator
{
	 ...
	 * 연산
	 *
	 * @return PunycodeCalculator
	 */
	public function execute()
	{
		$this->punycode = $this->encode( $this->options['domain'] );
		$this->result = true;
		return $this;
	}
	/**
	...
	{
		$data = array();
		$data['domain'] = $this->options['domain'];
		$data['punycode'] = $this->punycode;
		return $data;
	}
